...
object TestData {
    ...
    fun generateMockPlanetsResponse(page: Int, pageSize: Int, emptyList: Boolean = false): PlanetsResponse {
    ...
    fun mockedPager(): Pager<Int, PlanetEntity> {
        val fakeData = planets
